namespace Vaflov {
    public abstract class GameEvent5Base<V, T1, T2, T3, T4, T5> : GameEventBase where V : GameEvent5Base<V, T1, T2, T3, T4, T5> {
        ...
        public virtual void AddListener(GameEventListener<V, T1, T2, T3, T4, T5> listener) {
            #if UNITY_EDITOR
            base.AddListener(listener);
            #endif
        }

        public virtual void RemoveListener(GameEventListener<V, T1, T2, T3, T4, T5> listener) {
            #if UNITY_EDITOR
