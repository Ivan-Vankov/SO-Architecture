namespace Vaflov {
    public abstract class GameEvent6Base<V, T1, T2, T3, T4, T5, T6> : GameEventBase where V : GameEvent6Base<V, T1, T2, T3, T4, T5, T6> {
        ...
        public virtual void AddListener(GameEventListener<V, T1, T2, T3, T4, T5, T6> listener) {
            #if UNITY_EDITOR
            base.AddListener(listener);
            #endif
        }

        public virtual void RemoveListener(GameEventListener<V, T1, T2, T3, T4, T5, T6> listener) {
            #if UNITY_EDITOR
